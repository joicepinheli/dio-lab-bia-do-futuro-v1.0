...
O produto Fundo Imobililário (FII) substitiuiu o Fundo Multimercado, posi pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço, assim, poderei validar as respostas da Joy de forma mais assertiva.
...
Existem duas possibilidades, injetar os daods diretamente no prompt (Ctrl + C, Ctrl + V) ou carregar os arquivos via código.
